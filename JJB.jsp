...
<div style="margin: 2rem">
    <span style="font-family: 微软雅黑;font-size: 5.5rem">交接班</span>
    <a class="button" style="font-size: 4rem;margin-left: 3rem" data-toggle="modal" data-target="#jjblrModal">录入</a>
</div>
<%--搜索栏--%>
<div style="margin: 2rem;">
...
<div class="table-responsive">
    <table class="table table-bordered" id="table_jjb" style="font-size: 2rem"></table>
</div>

<%--交接班录入弹出窗口--%>
<div class="modal fade" id="jjblrModal" tabindex="-1" role="dialog" aria-labelledby="title">
    <div class="modal-dialog" role="document" style="width:70%;height: 30%;position: absolute;left: 15%;top: 30%">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title" id="title" align="center" style="font-size: 42px">交接班录入</h1>
            </div>
            <form class="form-inline" role="form" style="margin-top: 10%">
                <div class="form-group" style="margin-left: 13%;margin-bottom: 7%">
                    <label class="popup-label">交&nbsp;&nbsp;接&nbsp;&nbsp;人：</label>
                    <input type="text" id="jjr" class="popup-input" autocomplete="off" data-items="5">
                </div>
                <div class="form-group" style="margin-left: 13%;margin-bottom: 7%">
                    <label class="popup-label">交接时间：</label>
                    <input type="date" id="jjsj" class="popup-input" autocomplete="off" data-items="5">
                </div>
                <div class="form-group" style="margin-left: 13%;margin-bottom: 7%">
...
<script type="text/javascript">
    $(function () {
        // 初始化表格(检测申请)
        var jjbTable=new jjbTableInit();
        jjbTable.Init();
    });

    var jjbTableInit = function () {
        ...
        TableInit.Init = function () {
            ...
            var queryUrl = '';
            //销毁原来表格
            $('#table_jjb').bootstrapTable('destroy');
            //加载新表格
            $('#table_jjb').bootstrapTable({
...
//                 uniqueId: "jcsqdh",                     //每一行的唯一标识，一般为主键列
                ...
                columns: [
                    ...
                    { field: 'sj', title: '时间', valign: 'middle', align: 'center' },
                    { field: 'jl', title: '记录', valign: 'middle', align: 'center' },
